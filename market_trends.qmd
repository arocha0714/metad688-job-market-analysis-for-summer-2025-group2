...
```
As shown above, the range of salaries and AI impact can vary greatly by an individual state.
...
```{=html}
<iframe width="1000" height="700" src="./figures/top_industries.html" title="Analyst Distribution (with Salaries)"></iframe>
```